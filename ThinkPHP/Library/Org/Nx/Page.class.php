...
class Page{
	...
	// 分页显示定制<span class="rows">共 %TOTAL_ROW% 条记录</span>
    ...
    public function show() {
        ...
        $up_page = $up_row > 0 ? '<li><a class="prev" href="' . $this->url($up_row) . '">' . $this->config['prev'] . '</a></li>' : '<li><a class="prev" href="javascript:;">' . $this->config['prev'] . '</a></li>';

        //下一页
        $down_row  = $this->nowPage + 1;
        $down_page = ($down_row <= $this->totalPages) ? '<li><a class="next" href="' . $this->url($down_row) . '">' . $this->config['next'] . '</a></li>' : '<li><a class="next" href="javascript:;">' . $this->config['next'] . '</a></li>';
