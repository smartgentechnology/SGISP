...
class AutomailenController extends AuthController {
	
    public function index(){
		//网站产品
		$productsModel=M('','products','YW');
		//拼接查询条件
		$flag="is_delete =0";
		//日常工作计划未完成
	...
	public function send(){
		$productModel=M('','products','YW');
		$downloadModel=M('','download','YW');
		$productimgModel=M('','productimg','YW');
		$parameterModel=M('','parameter','YW');
		$parameteritemModel=M('','parameter_item','YW');
		$customerModel=D('Customeren');
		$id=I('get.id');
		...
		foreach($customerlist as $a){
			...
			$phpmailer->Subject='New Product-'.$productinfo['product_name'].$productinfo['product_feature'];
			$phpmailer->IsHTML(true);
			$strtop='
				<br>
				<div style="padding-left:50px;">
					<a href="http://www.smartgen.cn/index.php" target="_blank">
					<img src="http://www.smartgen.cn/view/front/userimage/l_logo.png">
					</a>
				</div>
				<br>';
			$strproductimg='<div><table width="100%"><tr><td width="50%"><center><a href="http://www.smartgen.cn/product.php?cat_id='.$productinfo['cat_id'].'&product_id='.$productinfo['product_id'].'" target="_blank" title="Click here for details"><img src="http://www.smartgen.cn/'.$productimg.'"/></a></center></td><td width="50%"><center><a href="http://www.smartgen.cn/product.php?cat_id='.$productinfo['cat_id'].'&product_id='.$productinfo['product_id'].'" target="_blank" title="Click here for details"><img width="80%" src="http://www.smartgen.cn/'.$jiexiantu.'"></a></center></td></tr><tr><td><center><h3><a href="http://www.smartgen.cn/product.php?cat_id='.$productinfo['cat_id'].'&product_id='.$productinfo['product_id'].'"  style="text-decoration:none; color:#000000" target="_blank" title="Click here for details">'.$productinfo['product_name'].'</a></h3></center></td><td><center><h3><a href="http://www.smartgen.cn/product.php?cat_id='.$productinfo['cat_id'].'&product_id='.$productinfo['product_id'].'" style="text-decoration:none; color:#000000" target="_blank" title="Click here for details">Typical Application</a></h3></center></td></tr></table></center></div>';
			if(empty($parameterlist)){
				...
				$strbody='<div style="background-color:#eeeeee"><br><table width="100%"><tr><td width="50%" style="padding-left:50px;"><center><strong><h3>Description</h3></strong></center>'.$productinfo['product_desc'].'</td><td width="50%" valign="top" style="padding-left:50px;"><center><strong><h3>Parameter List</h3></strong></center><table width="100%" style="margin-top:10px;"><tr><td width="50%" style="background-color:#000066; color:#FFFFFF;"><strong>Function Item</strong></td><td width="50%" style="background-color:#000066; color:#FFFFFF;"><strong>Parameter</strong></td></tr>'.$strpara.'</table></td></tr></table>';
			}
				...
				<table width="100%">
					<tr>
						...
						<td rowspan="6" align="right">
							...
							<p style="color:#FFFFFF;">SmartGen Product</p></center>
						</td>
						<td rowspan="6" align="right">
							<center><img width="80%" src="http://www.smartgen.com.cn/view/front/userimage/yun.jpg"><br>
							<p style="color:#FFFFFF;">SmartGen Cloud</p></center>
						</td>
					</tr>
					<tr>
